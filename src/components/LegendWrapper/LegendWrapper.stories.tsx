...
export const LegendWrapperRadio: Story<LegendWrapperProps> =
  TemplateWithRadio.bind({});
...
export const LegendWrapperRadioError: Story<LegendWrapperProps> =
  TemplateLegendErrorWithRadio.bind({});
LegendWrapperRadioError.storyName =
  "LegendWrapper with Error and Radio Buttons";
...
export const LegendWrapperCheckbox: Story<LegendWrapperProps> =
  TemplateWithCheckbox.bind({});
...
export const LegendWrapperErrorWithCheckbox: Story<LegendWrapperProps> =
  TemplateWithErrorAndCheckbox.bind({});
...
export const SU2CLegendWrapperRadioError: Story<LegendWrapperProps> =
