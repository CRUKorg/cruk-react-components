...
- Modal props extends from Dialog element attributes [#1267](https://github.com/CRUKorg/cruk-react-components/issues/1267)
- TextAreaField updated to use min-heigh when specifiying number of lines so that field-sizing content can be used expand the textarea [#1258](https://github.com/CRUKorg/cruk-react-components/issues/1258)
...
- Fixed fixed position varaiant for popover, to work when parent element is fixed or sticky position [#1245](https://github.com/CRUKorg/cruk-react-components/issues/1245)
...
- Fixed insconsistent disabled styling TextAreaField, and setting correct theme font on Select [#1196](https://github.com/CRUKorg/cruk-react-components/issues/1196)

## [7.2.4] - 2026-01-29

### Fixed

- Fixed CSS SVG Path color reset affecting inline attribute styling outside of components [#1174](https://github.com/CRUKorg/cruk-react-components/issues/1147)

## [7.2.3] - 2026-01-29

### Fixed

- Fixed PopOver target attribute from `popovertarget` to `popoverTarget` for proper React camelCase convention
- Corrected PopOver margin styles to prevent unwanted spacing [#1158](https://github.com/CRUKorg/cruk-react-components/issues/1158)

## [7.2.2] - 2026-01-29

### Added

- Added comprehensive README.md documentation for Carousel component with usage examples and props table
...
- In modal replaced react-intersectional-observer with a custom function [#1155](https://github.com/CRUKorg/cruk-react-components/issues/1155)

## [7.2.0] - 2025-01-27

### Changed

- Replacing custom popover code with browser native popover API and position anchoring [#1152](https://github.com/CRUKorg/cruk-react-components/issues/115)

## [7.1.6] - 2025-01-23

### Changed

- Replace react-portals and focus-lock with native html equivalent using dialog element and showModal() [#1151](https://github.com/CRUKorg/cruk-react-components/issues/1151)
